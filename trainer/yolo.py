...
class YOLO(object):
    _defaults = {
        ...
        # 2-1) to test the raccoon_dataset_derived_model
        "model_path": 'model_data/raccoon_derived_model.h5',
        "anchors_path": 'model_data/yolo_anchors.txt',
        # "classes_path": 'model_data/coco_classes.txt',
        # 2-2) to test the raccoon_dataset_derived_model
    ...
    def generate(self):
        ...
        try:
            ...
            print('output_shape = %d' %
                  (self.yolo_model.layers[-1].output_shape[-1]))
